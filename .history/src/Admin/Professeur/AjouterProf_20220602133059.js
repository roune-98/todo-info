                ...
                <div className='col col-lg-12'>
                    <form class="row row-cols-lg-auto g-3 align-items-center mt-5">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control ipt" id="inlineFormInputGroupUsername" placeholder="Nom" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                            <div class="input-group-text"><AiOutlineUserAdd className='i' /></div>
                            <input type="text" class="form-control ipt" id="inlineFormInputGroupUsername" placeholder="Prenom" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control ipt" id="inlineFormInputGroupUsername" placeholder="Telephone" />
                            </div>
                        </div>
