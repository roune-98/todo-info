                             ...
                             <table className="table align-middle mb-0 bg-white mt-5 ">
                                ...
                                <tbody>
                                {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <UpdateProf user={user.id} />
                                        <button className='btn btn-warning col' data-bs-toggle="modal" data-bs-target="#samaModal" onClick={e=> deleteUser(user.id)} ><GrUpdate/></button>
