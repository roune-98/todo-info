...
const SignUpAp =()=> {
  ...
  <button type="button" class="shadow-lg p-3 mb-5  rounded" data-bs-toggle="modal" data-bs-target="#myModal" style={{color:"#fff", backgroundColor:"#002639",fontWeight:"bolder",fontSize:"20px"}}>
    Ajouter
  </button>
