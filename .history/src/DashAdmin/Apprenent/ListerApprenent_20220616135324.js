                                ...
                                <tbody>
                                {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button 
                                                    type="button"
                                                    className="btn btns rounded border-0" 
                                                    style={{
                                        ...
                                        <td>
                                           ...
                                           <button className='btn1 btn-warning col' data-bs-toggle="modal" data-bs-target="#biModal"onClick={e=> setUser(appr)} ><GrDocumentUpdate/></button>
                                        </td>
                                        <td>
                                            <button 
                                                type="button"
