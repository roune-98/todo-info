...
const SignUpAp =()=> {
  ...
  <button type="button" class="shadow-lg p-2  w rounded border-0" data-bs-toggle="modal" data-bs-target="#myModal" style={{color:"#fff", backgroundColor:"#EC5251",fontWeight:"bolder",fontSize:"20px"}}>
  <IoIosAdd/>
  </button>
