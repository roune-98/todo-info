...
const SignUpAp =()=> {
  ...
  <button type="button" class="shadow-lg p-2   rounded bo" data-bs-toggle="modal" data-bs-target="#myModal" style={{color:"#fff", backgroundColor:"#EC5251",fontWeight:"bolder",fontSize:"20px"}}>
  <IoIosAdd/>
  </button>
