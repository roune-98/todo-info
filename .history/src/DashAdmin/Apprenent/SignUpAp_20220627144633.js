...
const SignUpAp =()=> {
  ...
  <button type="button" class="shadow-lg p-2   rounded" data-bs-toggle="modal" data-bs-target="#myModal" style={{color:"#fff", backgroundColor:"#E",fontWeight:"bolder",fontSize:"20px"}}>
  <IoIosAdd/>
  </button>
