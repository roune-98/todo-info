                ...
                <li className="nav-item app-header-right">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <button type="button" onClick={handleLogout} style={{color: "#002139"}} className="dropdown-item btn textSideOver font-weight-bolder"> <CgLogOut className='icon'/> Logout</button>
