           ...
           <table className="table align-middle mb-0 bg-white mt-5 ">
                                ...
                                <tbody>
                                {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <p className="mb-1" style={{color:"#07090b"}}>{cour.catego}</p>
                                        ...
                                        <td>
                                           ...
                                           <button className='btn1 btn-warning col rounded' data-bs-toggle="modal" data-bs-target="#coursModal"onClick={e=> setUser(cour)} ><GrDocumentUpdate/></button>
                                        </td>
                                        <td>
                                            <button 
                                                type="button"
