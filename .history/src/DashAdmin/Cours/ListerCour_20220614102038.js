                    ...
                    return(
                        ...
                        <div className="card-body " 
                            style={{backgroundColor:"#002639",
                                    ...
                                    >
                                          <h1 className="mb-1" style={{color:"#fff"}}>{user.titre}</h1>
                                          <p className="mb-1" style={{color:"#fff"}}>{user.titre}</p>
                                       
                                        <table className="table align-middle mb-0  mt-5 ">
                                ...
                                <table className="table align-middle mb-0 text-white mt-0 ">
                                            <thead>
                                                    <tr>
                                                    <th>Description</th>
                                                    </tr>
