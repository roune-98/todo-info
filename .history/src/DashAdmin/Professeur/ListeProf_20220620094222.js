                                       ...
                                       if(prof.archived === false){
                                            return(
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <button className='btn btn-warning col' data-bs-toggle="modal" data-bs-target="#samaModal"onClick={e=> setUser(prof)} ><FaPencilAlt/></button>
