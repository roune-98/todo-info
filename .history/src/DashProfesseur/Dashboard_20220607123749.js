    ...
    <div className="row d-flex justify-content-center align-items-center h-100">
      <div className="col-lg-12 col-xl-11">
            ...
            <form className=" mt-7 w-100" onSubmit={e=>ajoutContenu(e)}>
                  ...
                  <div className="d-flex flex-row align-items-center mb-2" onSubmit={e=>ajoutContenu(e)}>
                  ...
                  <div className="d-flex flex-row align-items-center mb-2">
                    ...
                    <div className="d-flex justify-content-center mx-4 mb-1 mb-lg-4">
                      <button type="sub" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", backgroundColor:"#002639",border:"none"}}>Submit</button>
                    </div>
