                                    ...
                                    return(
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                               ...
                                               <button className='btns rounded border-0  col' data-bs-toggle="modal" data-bs-target="#biModal"onClick={e=> setEvent(calend)} ><GrDocumentUpdate/></button>
                                            </td>
                                            <td>
                                               
                                               
                                               <button className='btns rounded border-0  col' data-bs-toggle="modal" data-bs-target="#biModal" onClick={e=>archiveEven(calend)}><BiArchiveIn/></button>
                                            </td>
