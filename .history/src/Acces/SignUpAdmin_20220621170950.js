...
import logo from "./logo.png";
    ...
    const SignUpAdmin = () => {
        ...
        //message de succés
        const [message, setMessage] = useState({ eror: false, msg: "" });
        ...
        async function handleSubmit(e) {
            ...
            //     setErremail(true);
            // }
            // if (!validPassword.test(mdtpass)) {
            //     setErrMdtpass(true);
            // }

            if (!email) {
                return setErremail("Veuillez saisir un email");
            } 
                                    ...
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                                        ...
                                        <div className='card'>
                                            <div className='card-body'>
                                                <p className="text-center h1 fw-bold mb-2 mx-1 mx-md-4 mt-4" style={{color:"#002639"}}>S'inscrire</p>
                                                ...
                                                <form className=" mt-7 w-100" onSubmit={handleSubmit} >
                                                    ...
                                                    <div className="d-flex flex-row align-items-center mb-1">
                                                        {/*mot passe*/}
                                                        <div className="form-outline flex-fill mb-2">
                                                        <Form.Control as='select' style= {{borderRadius:"10px", color:"gray"}}  
                                                        value={role} 
                                                    ...
                                                    <div className="d-flex justify-content-center mx-4 mb-1 mb-lg-2">
                                                        <button disabled={loadingData} type="submit" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", fontSize:"20px", backgroundColor:"#002639",border:"none",color:"#ec5251"}}>Submit</button>
                                                    </div>
