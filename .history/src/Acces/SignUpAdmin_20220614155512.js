...
const SignUpAdmin = () => {
    ...
    async function handleSubmit(e) {
        ...
        if (mdtpass !== confirmpass) {
            return setError("Veuillez entrer les même mot de passe")
        }
                                        ...
                                        <div className='card-body'>
                                            ...
                                            <form className=" mt-7 w-100" onSubmit={handleSubmit} >
                                                ...
                                                <div className="form-outline flex-fill mb-3">
                                                    ...
                                                    />
                                                {errEmail && <Alert variant="danger">{errEmail}</Alert>}
                                                </div>
                                                </div>
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    {/*mot passe*/}
                                                    ...
                                                    {errRole && <Alert variant="danger">{errRole}</Alert>}
                                                </div>
                                                ...
                                                <div className="form-outline flex-fill mb-3">
                                                    ...
                                                    />
                                                    {errMdtpass && <Alert variant="danger">{errMdtpass}</Alert>}
                                                </div>
                                                </div>
