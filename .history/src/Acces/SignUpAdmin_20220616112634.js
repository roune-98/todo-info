                                            ...
                                            <div className='card-body'>
                                                ...
                                                <form className=" mt-7 w-100" onSubmit={handleSubmit} >
                                                    ...
                                                    <div className="d-flex justify-content-center mx-4 mb-1 mb-lg-2">
                                                        <button disabled={loadingData} type="submit" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", fontSize:"45px",backgroundColor:"#002639",border:"none",color:"#ec5251"}}>Submit</button>
                                                    </div>
