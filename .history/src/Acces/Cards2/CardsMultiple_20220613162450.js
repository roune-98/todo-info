    ...
    <div className="col-md-10 ">
      <div className="row ">
          <div className="col-xl-3 col-lg-6">
              <div className="card w-100 l-bg-black-dark">
          ...
          <div className="col-xl-3 col-lg-6">
              <div className="card w-100 l-bg-white-dark">
                  <div className="card-statistic-3 p-4">
          ...
          <div className="col-xl-3 col-lg-6">
              <div className="card w-100 l-bg-redsalsa-dark">
                  <div className="card-statistic-3 p-4">
          ...
          <div className="col-xl-3 col-lg-6">
              <div className="card w-100 l-bg-prussianblue-dark">
                  <div className="card-statistic-3 p-4">
                      <div className="card-icon card-icon-large"><BsFillCalendar2RangeFill className="w-25 fas"/></div>
                      <div className="mb-4">
