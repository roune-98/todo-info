...
const SignUpAdmin = () => {
  ...
  async function handleSubmit(e) {
    ...
    if (mdtpass !== confirmpass) {
      return alert("Veuillez entrer les même mot de passe");
    }
    ...
    try {
      ...
      alert("Utilisateur Ajoutée avec succés!", "Cliquez sur le button!", "success"); 
      // console.log(message);
      history("/login");
    } catch (err) {
      alert("{err.message}", "Cliquez sur le button!", "danger"); 
    }
                ...
                <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                  <div className="card">
                      ...
                      <form className=" mt-7 w-100" onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex flex-row align-items-center mb-1">
                          ...
                          <div className="form-outline flex-fill mb-2">
                            ...
                            >
                              <option value="">Designer l'utilisateur</option>
                        ...
                        <div className="d-flex flex-row align-items-center mb-1">
                          ...
                          <div className="form-outline flex-fill mb-2">
                            ...
                            />
                            {errMdtpass && (
                              <p className="text-danger">{errMdtpass}</p>
                            )}
                          </div>
                        </div>
                    ...
                    <div className="w-100 text-center">
                      Already have an account? <Link to="/login">connéxion</Link>
                    </div>
                  </div>
                </div>
              </div>
