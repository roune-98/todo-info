...
const SignUp =()=> {
  ...
  return (
    <div>
        ...
        <button type="button" class="shadow-lg p-2  v rounded border-0" data-bs-toggle="modal" data-bs-target="#myModal" style={{color:"#fff", backgroundColor:"#EC5251",fontWeight:"bolder",fontSize:"20px"}}>
  <IoIosAdd/>
  </button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content w-100">
      ...
      <div class="modal-header">
         <h4 class="modal-title">Professeur</h4> 
                    ...
                    <form className=" mt-7 w-100" onSubmit={handleSubmit} >
                        ...
                        <div className="form-outline flex-fill mb-3">
                            <input type="text" id="tel"
                                name="prenom" className="form-control" 
                                placeholder=' votre numero tel :'style={{borderRadius:"10px"}}
                        ...
                        <div className="d-flex justify-content-center mx-4 mb-1 mb-lg-4">
                            <button disabled={loadingData} type="submit" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", backgroundColor:"#002639",border:"none"}}>Enregistrer</button>
                        </div>
