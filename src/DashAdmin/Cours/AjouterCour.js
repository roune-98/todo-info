...
const AjouterCour =()=> {
    ...
    const ajoutContenu = (e)=>{
        ...
        alert("Le Cour est ajoute avec succsse", " Clic sur Ok", "success");
        addDoc(collection(db,"cours"),user)
                      ...
                      <form className=" mt-7 w-100" onSubmit={e=>ajoutContenu(e)} >
                            ...
                            <div className="d-flex flex-row align-items-center mb-2">
                              ...
                              <div className="d-flex justify-content-center mx-4 mb-2 mb-lg-4">
                                <button type="submit" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", backgroundColor:"#002639",border:"none"}}>Ajouter</button>
