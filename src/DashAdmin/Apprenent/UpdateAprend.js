...
import modifier from "sweetalert"
...
const UpdateAprend = (props) => {
    ...
    const updateUser = (e)=>{
      modifier("  Apprenant modifier avec succée"  , "Clique sur OK", "success")
    ...
    return (
        <>
           <div class="modal mt-5" id="biModal">
                      ...
                      <form className=" mt-7 w-100" onSubmit={e=>updateUser(e)} >
                            ...
                            <div className="d-flex flex-row align-items-center mb-2">
                              ...
                              <div className="d-flex justify-content-center mx-4 mb-2 mb-lg-4">
                                <button type="submit" className="btn btn-primary btn-block mb-4 form-control" style={{borderRaduis:"10px;", 
                                backgroundColor:"#002639",border:"none"}} >Modifier</button>
                              </div>
